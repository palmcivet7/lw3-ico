...
export default function Home() {
  ...
  const mintCryptoDevToken = async (amount) => {
    try {
      ...
      await tx.wait();
      setLoading(false);
      window.alert("Successfully minted Palmcivet Crypto Dev Tokens");
  ...
  const claimCryptoDevTokens = async () => {
    try {
      ...
      await tx.wait();
      setLoading(false);
      window.alert("Sucessfully claimed Palmcivet Crypto Dev Tokens");
      await getBalanceOfCryptoDevTokens();
      await getTotalTokensMinted();
      await getTokensToBeClaimed();
    } catch (err) {
  ...
  return (
    <div>
      <Head>
        <title>Palmcivet ICO Test</title>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>
            Welcome to Palmcivet Crypto Devs ICO!
          </h1>
          <div className={styles.description}>
            You can claim or mint Palmcivet Crypto Dev tokens here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="./palmcivet-stencil.jpg" />
        </div>
      </div>
